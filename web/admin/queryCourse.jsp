...
<script type="text/javascript">
    ...
    var fillToTable = function (courseInfos) {
        ...
        $.each(courseInfos.list, function (index, courseInfo) {
            ...
            td.html("<button type='button' class='btn btn-default btn-sm'>" +
                "<span class='glyphicon glyphicon-edit' onclick='edit_course("+courseInfo.courseId+")'></span> 编辑" +
                "</button>&nbsp;<button type='button' class='btn btn-default btn-sm'>" +
                "<span class='glyphicon glyphicon-trash' onclick='delete_course("+courseInfo.courseId+")'></span> 删除" +
                "</button>");
            tr.append(td);
    ...
    function delete_course(course_id) {
        ...
        //提交请求
        $.ajax({
            url: "${pageContext.request.contextPath}/course/ajax/deleteCourse",
            type: "POST",
    ...
    function to_page(pageNum) {
        $.ajax({
            url: "${pageContext.request.contextPath}/course/ajax/findCourses",
